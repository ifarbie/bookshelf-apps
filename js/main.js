document.addEventListener('DOMContentLoaded', function () {
  ...
  function makeBookItem(bookObject) {
    ...
    if (!bookObject.isComplete) {
      ...
      checkBookButton.setAttribute('data-testid', 'bookItemIsCompleteButton');
    ...
    cardBody.innerHTML = `
            <h3 class="card-title fs-5" data-testid="bookItemTitle">${bookObject.title}</h3>
            <h4 class="card-subtitle text-body-secondary mb-2 fs-6" data-testid="bookItemAuthor">Penulis: ${bookObject.author}</h4>
            <h6 class="card-subtitle text-body-secondary mb-3" data-testid="bookItemYear">Tahun: ${bookObject.year}</h6>`;
